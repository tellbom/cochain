<template>
    <el-popover :placement="placement" trigger="focus" :hide-after="0" :width="selectorWidth" :visible="popoverVisible">
        <div class="icon-selector" @mouseover.stop="iconSelectorMouseover = true" @mouseout.stop="iconSelectorMouseover = false">
            <div class="selector-header">
                <div class="selector-title">{{ title || '请选择图标' }}</div>
                <div class="selector-tab">
                    <span title="Element Plus 图标" :class="{ active: iconType === 'ele' }" @click="changeTab('ele')">ele</span>
                    <span title="Font Awesome 图标" :class="{ active: iconType === 'awe' }" @click="changeTab('awe')">awe</span>
                </div>
            </div>
...
import { getAwesomeIconfontNames, getElementPlusIconfontNames } from '/@/utils/iconfont'

type IconType = 'ele' | 'awe'
