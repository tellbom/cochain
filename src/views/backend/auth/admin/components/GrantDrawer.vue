        ...
        <div class="grant-content" v-loading="loading">
            ...
            <div class="user-card" v-if="target">
                ...
                <div class="user-card__badge">
                    <el-tag v-if="target.isSuper" size="small" class="super-badge">超管</el-tag>
            ...
            <div class="action-group">
                ...
                <div class="action-item" v-if="!isGranted">
                    ...
                    <el-button type="primary" size="small" :loading="actionLoading.grant" @click="handleGrant(false)"> 授权 </el-button>
                </div>
                ...
                <div class="action-item" v-if="!isGranted">
                    ...
                    <el-button type="warning" size="small" :loading="actionLoading.grantSuper" v-if="canManageSuper" @click="handleGrant(true)">
                        授权为超管
                    </el-button>
                </div>
                ...
                <div class="action-item action-item--danger" v-if="isGranted">
                    ...
                    <el-button type="danger" size="small" plain :loading="actionLoading.revoke" @click="handleRevoke"> 撤销授权 </el-button>
                </div>
            </div>
        </div>
...
import { grantProjectAccess, revokeProjectAccess, toggleProjectSuper, type AdminItem } from '/@/api/backend/rbac'
...
// ── 按钮权限：只有超管才能操作超管切换 ────────────────────────
const canManageSuper = computed(() => adminInfo.super || false)
