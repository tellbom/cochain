<template>
    <div class="rbac-grant-page">
        ...
        <div class="page-header">
            ...
            <el-tag v-if="adminInfo.super" size="small" class="self-super-tag"> <i class="fa fa-star" /> 当前账号：超管 </el-tag>
        </div>
        ...
        >
            ...
            <template #grantStatus="{ row }">
                <el-tag :type="isGranted(row) ? 'success' : 'info'" size="small">
...
import { getAdminList, toggleProjectSuper, RBAC_PROJECT, type AdminItem } from '/@/api/backend/rbac'
...
const selfUserid = computed(() => adminInfo.userid ?? '')
const canManage = computed(() => adminInfo.super === true)
...
:deep(.el-tag--info) {
    --el-tag-bg-color: #f5f5f7;
    --el-tag-border-color: #e0e0e0;
    --el-tag-text-color: #86868b;
}
